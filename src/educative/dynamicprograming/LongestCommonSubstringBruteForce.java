...
{
  public static int longestCommonSubstrLengthRec(String s1, String s2)
  {
  ...
  public static void main(String[] args) {
    String string1 = "EducativeIsFun";
    String string2 = "AlgorithmsAreFun ";
    System.out.println(longestCommonSubstrLengthRec(string1,string2));
  }
}